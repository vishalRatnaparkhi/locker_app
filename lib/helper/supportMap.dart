...
class SupportMapView extends StatefulWidget {
  @override
  Struct s;
  SupportMapView(this.s);
  State createState() => _SupportMapViewState(s);
}

class _SupportMapViewState extends State<SupportMapView> {
  String lock;
  Struct locker;
  ...
  Widget build(BuildContext context) {
    if (currentPosition == null)
      currentPosition = new Position(latitude: s.lat, longitude: s.lng);
