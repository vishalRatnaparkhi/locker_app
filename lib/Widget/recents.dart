          ...
          return Padding(
            ...
            child: GestureDetector(
              onTap: () => {
                ...
                Navigator.push(
                    context, FadeRoute(page: SupportMapView(recentList[index])))
              },
              child: Card(
                  ...
                  elevation: 6,
                  color:
                      selected[index] ? Colors.indigo[500] : Colors.indigo[300],
                  child: Padding(
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    recentList[index].availablelockers,
                                    style: TextStyle(
